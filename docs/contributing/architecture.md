...
3. **Rendering** — each planned artifact invokes a `TemplateRenderer`. **Model** HTTP templates already receive neutral [`TemplateView`](../../modules/smithplates-codegen-core/src/main/scala/com/jacoby6000/smithplates/codegen/core/planning/TemplateView.scala) with `usedTypes` and [`Conventions`](../../modules/smithplates-codegen-core/src/main/scala/com/jacoby6000/smithplates/codegen/core/strategy/Conventions.scala) from a [`NamingStrategy`](../../modules/smithplates-codegen-core/src/main/scala/com/jacoby6000/smithplates/codegen/core/strategy/NamingStrategy.scala). Remaining SQL db and HTTP server/client SSP templates still bridge to legacy stringly views (`ServiceTemplateView`, `HttpCodegenTemplateView`) inside the feature renderers until those templates migrate.
