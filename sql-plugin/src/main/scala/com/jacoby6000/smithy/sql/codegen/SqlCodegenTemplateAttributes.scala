...
import com.jacoby6000.smithy.sql.PostgresDialect
...
object SqlCodegenTemplateAttributes {
  ...
  private def renderJsonTypeHelpers(
      ...
      operations: List[SqlCodegenOperation],
      rowTypeName: String,
      dialect: com.jacoby6000.smithy.sql.SqlDialect
  ): List[String] = {
  ...
  private def renderJsonRowData(dialect: com.jacoby6000.smithy.sql.SqlDialect): String =
    dialect match {
...
${memberIndent})"""
  ...
  private def renderRowReaderImports(dialect: com.jacoby6000.smithy.sql.SqlDialect, operations: List[SqlCodegenOperation]): String = {
