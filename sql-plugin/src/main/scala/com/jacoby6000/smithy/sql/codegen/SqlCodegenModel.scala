...
import com.jacoby6000.smithy.sql.SqlDialect
...
final case class SqlCodegenSqlBinding(
    queryKind: String,
    sqlStatement: com.jacoby6000.smithy.sql.shared.SqlParameterizedStatement,
    tableName: String,
...
final case class SqlCodegenServiceContext(
    ...
    version: String,
    dialect: SqlDialect,
    bindPlaceholderStyle: com.jacoby6000.smithy.sql.shared.SqlBindPlaceholder,
