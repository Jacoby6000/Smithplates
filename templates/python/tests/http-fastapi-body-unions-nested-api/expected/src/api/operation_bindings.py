...
OPERATION_HTTP_BINDINGS: dict[str, OperationHttpBinding] = {
    "create_content": OperationHttpBinding(
        variants_by_type_name={
            "ContentOutput": ResponseVariantBinding(
                status_code=201,
    ...
    "CreateContent": OperationHttpBinding(
        variants_by_type_name={
            "ContentOutput": ResponseVariantBinding(
                status_code=201,
                media_type="application/json",
    ...
    "get_content": OperationHttpBinding(
        variants_by_type_name={
            "ContentOutput": ResponseVariantBinding(
                status_code=200,
                media_type="application/json",
    ...
    "GetContent": OperationHttpBinding(
        variants_by_type_name={
            "ContentOutput": ResponseVariantBinding(
                status_code=200,
                media_type="application/json",
