...
object SqlItModelLoader {
  val SqlSchemaTraitsModelId: String  = "META-INF/smithy/stache.codegen.sql.smithy"
  val SqlServiceTraitsModelId: String = "META-INF/smithy/stache.codegen.sql.service.smithy"
