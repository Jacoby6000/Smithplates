...
import com.jacoby6000.smithy.stache.sql.service.SqlSelectJoinResolver.ResolvedForeignKey
...
private[service] object SqlDeriveSelectOneExtractor {
  private val DerivedStructShapeId: ShapeId = ShapeId.from("stache.codegen.sql#DerivedStruct")
